...
<div class="col-md-5">
    <div class="card">
        <div class="card-header">
            Formulario de inventario de los productos
        </div>
        <div class="card-body">
        <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"  name="precio" id ="precio" value="<?php echo $precio ?>" class="form-control" placeholder="Digite el numero de productos">
                    </div>
